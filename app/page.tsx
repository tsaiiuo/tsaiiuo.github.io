							...
							<div className="flex h-full flex-col gap-8 lg:sticky lg:top-6 lg:max-h-[calc(100vh-3rem)] lg:justify-between lg:overflow-auto">
								<div className="space-y-8">
									...
									<div className="grid gap-3 sm:grid-cols-2">
										<a
											href="mailto:tsaiiuo1@gmail.com"
											className="rounded-2xl bg-[color:var(--foreground)] px-5 py-4 text-sm text-white transition hover:translate-y-[-1px]"
										>
											Email
										...
										<a
											...
											target="_blank"
											rel="noreferrer"
											className="rounded-2xl border border-[color:var(--line)] bg-white/80 px-5 py-4 text-sm transition hover:border-[color:var(--accent)]"
										>
											GitHub
												...
												<div key={group.title} className="rounded-2xl border border-[color:var(--line)] bg-[color:var(--surface-strong)] p-4">
													...
													<div className="mt-3 flex flex-wrap gap-2">
														{group.items.map((item) => (
															<span
																key={item}
																className="rounded-full border border-[color:var(--line)] bg-white px-3 py-1 text-sm text-[color:var(--muted)]"
															>
																{item}
															</span>
														))}
